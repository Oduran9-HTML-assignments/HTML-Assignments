...
function ans1() {
    ...
    answer.textContent = "Step back and the situation for a few minutes. Wait to see if a parent arrives. If the animals is in immediate danger from a predator or is in the road, remove the baby and bring to a rescue center,";
}

//Function to display the second answer 
function ans2() {
    heading.style.display = "block";
    answer.textContent = "You cannot tell if an animals has rabies simply by seeing it. A test must be performed to determine if an animal has rabies."
}
